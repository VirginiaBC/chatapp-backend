  ...
  try {
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a good teacher and can help students generate synonymous sentences",
        }, // this represents the bot and what role they will assume
        {
          role: "user",
          content: `Generate a synonymous sentence: I generate this image for you.`,
    ...
    await axios.post(
      `https://api.chatengine.io/chats/${activeChatId}/messages/`,
      {
        ...
        attachment_urls: [response.data.data[0].url],
      },
      {
        headers: {
          "Project-ID": process.env.PROJECT_ID,
